using EmpCoreClient.Infrastructure;
using EmpCoreClient.ViewModels;
    ...
    public class EmployeeController : Controller
    {
        ...
        public IActionResult Create(EmployeeViewModel viewModel, IFormFile file)//public IActionResult Create(EmployeeViewModel viewModel, IFormFile file)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                _httpClient.BaseAddress = new Uri("https://localhost:7054/api/Employee/AddEmployee");
                var response = _httpClient.PostAsync("https://localhost:7054/api/Employee/AddEmployee", content).Result;
        ...
        public IActionResult Edit(UpdateEmployeeViewModel updateEmployee, IFormFile file)
        {
            if (ModelState.IsValid)
            {
                ...
                HttpClient _httpClient = new HttpClient();
                _httpClient.BaseAddress = new Uri("https://localhost:7054/api/Employee/UpdateEmployee");
                var response = _httpClient.PutAsync("https://localhost:7054/api/Employee/UpdateEmployee", content).Result;
